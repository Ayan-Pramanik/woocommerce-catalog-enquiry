...
class Ajax {
	...
	public function send_product_enqury_mail() {
		...
		$settings_form = CE()->options_form_settings;
		...
		if (isset($settings['is_other_admin_mail']) && Utill::mvx_catalog_get_settings_value($settings['is_other_admin_mail'], 'checkbox') == 'Enable') {
			$email_admin = '';
		} else {
